...
public class message_fragment {
    ...
    public message_fragment(LayoutInflater inflater, ConstraintLayout constra) {
        minflater = inflater;
        mconstra = constra;
        view = minflater.inflate(R.layout.message_layout_1,mconstra,false);
        Mode = 1;

        constra.removeAllViews();
        constra.addView(view);

        ImageView image = (ImageView) view.findViewById(R.id.message_blur_image);
    ...
    public void setMode(int mode)
    {
        ...
        if(Mode ==1)
            ...
            view = minflater.inflate(R.layout.message_layout_2,mconstra,false);
